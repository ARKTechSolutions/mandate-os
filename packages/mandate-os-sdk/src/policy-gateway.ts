...
export const defaultHostGatewayRules: MandateOsPolicyGatewayRule[] = [
  ...
  {
    id: 'local.directory.create.command',
    channel: 'shell',
    matcher: '(^|[\\n;&|]+)\\s*mkdir\\b',
    flags: 'i',
    tool: 'shell.exec',
    title: 'Create a local directory',
    description: 'Create a local directory with command: {command}',
    zone: 'domestic',
    riskLevel: 'medium',
    route: 'generic',
  },
  {
    ...
    description: 'Delete local files or directories with command: {command}',
    zone: 'restricted',
    riskLevel: 'high',
    route: 'generic',
  },
