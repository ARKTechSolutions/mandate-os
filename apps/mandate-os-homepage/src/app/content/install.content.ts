...
export MANDATE_OS_MCP_DEFAULT_SOURCE="cursor.mandateos.project"`,
  ...
  },
  {
    ...
    body: 'Ask Cursor to run the approval and blocked commands below. In both cases your AI will be blocked from taking action; in practice you can adjust the requirement yourself in the MandateOS dashboard (not available in this demo).',
    help: 'The commands below are wired into the demo mandate so you can see MandateOS stop the agent.',
    codeTabs: [],
  },
];
